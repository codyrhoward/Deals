...
class DealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deal" do
    assert_difference('Deal.count') do
      post deals_url, params: { deal: { category: @deal.category, content: @deal.content, restaurant: @deal.restaurant } }, as: :json
    end
  ...
  test "should update deal" do
    patch deal_url(@deal), params: { deal: { category: @deal.category, content: @deal.content, restaurant: @deal.restaurant } }, as: :json
    assert_response 200
  end
